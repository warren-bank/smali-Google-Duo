...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Lvq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 5
    iput-boolean v2, p0, Lvq;->f:Z
...
.method public static a(Landroid/view/ViewGroup$LayoutParams;)Lsw;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lsw;-><init>(Lsw;)V
    ...
    invoke-direct {v0, p0}, Lsw;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private final b(Landroid/util/AttributeSet;)Lsw;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lsw;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
# virtual methods
.method public final synthetic a(Landroid/util/AttributeSet;)Lvr;
    .locals 1

    .prologue
    .line 313
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->b(Landroid/util/AttributeSet;)Lsw;
...
.method public final a(Lrf;)V
    ...
    .prologue
    .line 281
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lrf;

    .line 282
    return-void
.end method

.method public final a(Lru;Lrg;)V
    .locals 0

    .prologue
    .line 294
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->l:Lru;

    .line 295
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->d:Lrg;
...
.method public final a(Lrj;)Z
    ...
    .prologue
    .line 278
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lrf;
...
.method public final b()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Lrf;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lrf;

    .line 286
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lrf;

    new-instance v2, Lsx;

    invoke-direct {v2, p0}, Lsx;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Lrf;->a(Lrg;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->l:Lru;
    ...
    invoke-virtual {v0, v1, v2}, Lrf;->a(Lrt;Landroid/content/Context;)V
...
.method protected final synthetic b(Landroid/view/ViewGroup$LayoutParams;)Lvr;
    .locals 1

    .prologue
    .line 311
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lsw;
...
.method protected final synthetic d()Lvr;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 21
    invoke-super {p0, p1}, Lvq;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onDetachedFromWindow()V
    ...
    .prologue
    .line 264
    invoke-super {p0}, Lvq;->onDetachedFromWindow()V
...
.method protected onLayout(ZIIII)V
    ...
    .line 190
    invoke-super/range {p0 .. p5}, Lvq;->onLayout(ZIIII)V
    ...
    iget-boolean v5, v0, Lsw;->a:Z

    if-nez v5, :cond_b

    .line 243
    iget v5, v0, Lsw;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lrf;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lrf;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lrf;->b(Z)V
    ...
    iput-boolean v7, v6, Lsw;->d:Z

    .line 72
    const/4 v7, 0x0

    iput v7, v6, Lsw;->leftMargin:I

    .line 73
    const/4 v7, 0x0

    iput v7, v6, Lsw;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Lsw;->e:Z

    .line 75
    iget-boolean v7, v6, Lsw;->a:Z
    ...
    iput-boolean v8, v6, Lsw;->f:Z

    .line 157
    if-nez v9, :cond_17

    iget-boolean v8, v6, Lsw;->e:Z
    ...
    iput v9, v6, Lsw;->rightMargin:I

    iput v9, v6, Lsw;->leftMargin:I
    ...
    .line 187
    :cond_23
    invoke-super/range {p0 .. p2}, Lvq;->onMeasure(II)V
