...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, Ltr;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 31
    invoke-direct {p0, v0, p2}, Ltr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Lhr;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Ltr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 49
    iget-object v0, p0, Ltr;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 50
    iput-object v1, p0, Ltr;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iget-object v0, p0, Ltr;->c:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, p1, v1, p2, v3}, Lxz;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lxz;

    move-result-object v4

    .line 5
    invoke-virtual {v4, v3}, Lxz;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    iget-object v5, p0, Ltr;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Ltr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 22
    :cond_2
    invoke-virtual {v4, v9}, Lxz;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 24
    iget-object v1, p0, Ltr;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Ltr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 26
    :cond_3
    iget-object v0, v4, Lxz;->b:Landroid/content/res/TypedArray;
